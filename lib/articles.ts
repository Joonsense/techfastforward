  ...
  const all: Article[] = [
    {
      ...
      title_ko: null, subtitle_ko: null, excerpt_ko: null,
      ...
      korea_impact: null, korea_impact_ko: null,
    ...
    },
    {
      ...
      body_html: '<p>The EU AI Act has entered its high-risk enforcement phase. Companies deploying AI systems in healthcare, financial services, and law enforcement must now demonstrate compliance or face fines up to 35 million euros or 7% of annual global turnover.</p>',
      ...
      key_takeaways: ['Healthcare and fintech AI deployments require immediate compliance documentation', '35M euro fine cap applies per violation', 'US tech giants face largest compliance burden given EU market scale'],
      korea_impact: null, korea_impact_ko: null,
